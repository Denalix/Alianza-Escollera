...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// BOYA 1 BOYA 1 BOYA 1 BOYA 1 BOYA 1 BOYA 1 BOYA 1 BOYA 1 BOYA 1 BOYA 1 BOYA 1 BOYA 1 BOYA 1 BOYA 1  BOYA 1  BOYA 1  BOYA 1  BOYA 1  BOYA 1  BOYA 1  BOYA 1  BOYA 1  BOYA 1
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
int port_numBoya = 1;
...
//// 78262543707 para otro gateway
//// LoRaWAN NwkSKey, network session key
//// This should be in big-endian (aka msb).
////                                          6F    FE    1A    3B    41    62    6B    87    79    A1    0A    90    01    C9    E7    BB
//static const PROGMEM u1_t NWKSKEY[16] = { 0x6F, 0xFE, 0x1A, 0x3B, 0x41, 0x62, 0x6B, 0x87, 0x79, 0xA1, 0x0A, 0x90, 0x01, 0xC9, 0xE7, 0xBB };
//
//// LoRaWAN AppSKey, application session key
//// This should also be in big-endian (aka msb).
////                                        95    3C    8A    A7    55    F7    17    E7    8B    38    A6    45    64    3A    88    FC
//static const u1_t PROGMEM APPSKEY[16] = { 0x95, 0x3C, 0x8A, 0xA7, 0x55, 0xF7, 0x17, 0xE7, 0x8B, 0x38, 0xA6, 0x45, 0x64, 0x3A, 0x88, 0xFC };
//
//// LoRaWAN end-device address (DevAddr)
//// See http://thethingsnetwork.org/wiki/AddressSpace
//// The library converts the address to network byte order as needed, so this should be in big-endian (aka msb) too.
////                          26 0D 15 F1
//static const u4_t DEVADDR = 0x260D15F1; // <-- Change this address for every node!
...
const unsigned TX_INTERVAL = 60*25;// seconds; chage the second number to the minutes you need the interval to be minus 5 minute of the process
