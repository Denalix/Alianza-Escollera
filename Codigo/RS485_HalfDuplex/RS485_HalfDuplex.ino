...
#define MAX485_DE_RE  2  // Connect RE an DE terminals with pin 2 of TTGO T-beam   
#define energyControlPin 4


const uint16_t _u16BaudRate = 9600;
const uint8_t idConductivitySensor = 1;
