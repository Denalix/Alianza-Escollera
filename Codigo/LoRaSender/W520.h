...
class W520 : public ModbusSerial{
  private:
    Stream* _port;
    long  _baud;
    int   _txPin;
  ...
  public:
    ...
    void setSlaveIDRequest();
    void startMeasurementRequest();
    int getSerialNumberRequest(int DE, int RE,byte *ByteArray,unsigned int t_15,unsigned int t_35);
    int getTempCondRequest(int DE, int RE, byte* ByteArray,unsigned int t_15,unsigned int t_35);
